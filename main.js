...
var main=function(args){
    ...
    mySVG.text({x:1350,y:1350,text:"This is a sample text",'font-family':'Arial','font-size':'20px',fill:'black',style:'user-select:none;'})
	mySVG .image({y:1320,x:1500,width:200,height:200,href:"https://research.dwi.ufl.edu/op.n/img/logo.png",preserveAspectRatio:"none"});
